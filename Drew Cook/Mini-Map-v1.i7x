Version 1.0.0 of Mini-Map by Drew Cook begins here.

"Prints a mini-map of the player's current location, with the player at the map's center. Since this is integrated with mathbrush's 'Bisquixe' interpreter, various rooms are displayed as hyperlinks. Other than including the needed extensions, this should work automatically. As rooms are added to the project, the mini-map should display the relevant information.

Mini-Map does not require a Bisquixe interpreter. It should function in most interpreters. It nevertheless does require Simple Multimedia Effects for v10.

Mini-Map has only been tested with Inform 10.1.2"
...
It's best to buid with the extension in mind. Keep things on a neat grid with reciprocating exits and everything ought to fall into place.
...
Mini-Map uses Simple Multimedia Effects for v10. To learn more about SME or the Bisquixe interpreter:
	
https://intfiction.org/t/an-authors-reference-for-bisquixe-a-tool-for-adding-audiovisual-content-to-inform-projects/79527
