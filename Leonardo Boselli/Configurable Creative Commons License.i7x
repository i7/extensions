Version 1/140818 of Configurable Creative Commons License by Leonardo Boselli begins here.
...
To say CC image name:
	if CC license chosen is by-nc-nd:
		say "cc by-nc-nd";
	otherwise if CC license chosen is by-nc-sa:
		say "cc by-nc-sa";
	otherwise if CC license chosen is by-nc:
		say "cc by-nc";
	otherwise if CC license chosen is by-nd:
		say "cc by-nd";
	otherwise if CC license chosen is by-sa:
		say "cc by-sa";
	otherwise if CC license chosen is by:
		say "cc by";
	otherwise:
		say "cc by-nc-nd";
...
When play begins while suppress CC license banner is not true (this is the print CC deed on startup rule):
	...
	say "[line break]";
	if suppress CC deed on startup is true, say "This work is licensed under a [italic type]Creative Commons
	[expanded CC license name of CC license chosen] License[roman type]. For more information, type '[command deed]' at command prompt." (A);
...
Section K - Automated announcement (for use without Hyperlink Interface by Leonardo Boselli)
...
Section H - Automated announcement (for use with Hyperlink Interface by Leonardo Boselli)
...
To display the license section 1 specific to (variant - by-sa):
	...
	say "c. [bold type]'Creative Commons Compatible License'[roman type] means a license that is listed at [if FOR-WEB is true]<a href='http://creativecommons.org/compatiblelicenses' target='_blank'>http://creativecommons.org/compatiblelicenses</a>[otherwise]http://creativecommons.org/compatiblelicenses[end if]
...
To display the license notice:
	...
	say "[line break]";
	say "Creative Commons may be contacted at [if FOR-WEB is true]<a href='http://creativecommons.org/' target='_blank'>http://creativecommons.org/</a>[otherwise]http://creativecommons.org/[end if]."
...
To display the warranty:
	...
	this work. You may view the entire license by typing the command '[command license][italic type]' at the prompt.[roman type]";
	say "[line break]".
...
To display the deed specific to (variant - a CC license type):
	say "[if FOR-WEB is true]<a href='http://creativecommons.org/licenses/[CC license chosen]/3.0/' target='_blank'><img src='interpreter/[CC image name].png' align='right'/></a>[end if]This work is licensed under a Creative Commons [expanded CC license name of CC license chosen]
	License.";
	say "[line break]";
	...
	of this work. The best way to do this is with a link to [if FOR-WEB is true]<a href='http://creativecommons.org/licenses/[CC license chosen]/3.0/' target='_blank'>http://creativecommons.org/licenses/[CC license chosen]/3.0/</a>[otherwise]http://creativecommons.org/licenses/[CC license chosen]/3.0/[end if]";
	say "[paragraph break]";
	...
	by typing the command '[command deed][italic type]' at the prompt. To see the official license, type the command '[command license][italic type]' at the prompt.
	For warranty information, type the command '[command warranty][italic type]'.[roman type]";
	say "[line break]".
