Version 3/140811 of Basic Help Hyperlinks IT by Leonardo Boselli begins here.
...
To announce the help availability:
	say "[italic type](Scrivi [t]AIUTO[x][italic type] se non sai come procedere)[roman type][paragraph break]".
...
Basic Help Hyperlinks IT ends here.
