...
Chapter - Responses
    ...
    saying yes or no to someone rule response (A) is "'[if saying yes]Sì[otherwise]No[end if]', [regarding the player][hai] risposto.[paragraph break]'Ma non [ti] [regarding the current interlocutor][hai] chiesto nulla', [hai] puntualizzato.".
