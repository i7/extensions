Version 2/101030 of Glulx Status Window Control (for Glulx only) by Erik Temple begins here.
...
If we've changed our background color and wish to change things back to the default, we type:
