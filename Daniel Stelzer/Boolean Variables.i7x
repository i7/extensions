...
Report boolean toggling: say "[Noun] [if the noun is active]on[otherwise]off[end if]."
...
Report boolean truth setting: say "[Noun] on."
...
Report boolean falsehood setting: say "[Noun] off."
...
Carry out listing boolean options:
	...
	repeat with the item running through boolean options:
		say "[if the item is active]*[otherwise] [end if] [Item][line break]";
