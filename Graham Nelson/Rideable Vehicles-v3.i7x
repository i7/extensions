Version 3/220311 of Rideable Vehicles by Graham Nelson begins here.
...
Section Can't Eat Other People's Food fix

Check an actor eating (this is the rideable vehicles compatible can't eat other people's food rule):
  if the actor does not enclose the noun and the noun is enclosed by a person begin;
    if the actor is the player begin;
      let the owner be the noun;
      while the owner is not a person begin;
...
3/220311: added Can't Eat Other People's Food fix per https://github.com/i7/extensions/issues/78
