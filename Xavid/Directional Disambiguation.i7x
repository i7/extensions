...
This extension provides support for assuming the player meant to go that direction, not answer the question, when they type a direction word in response to a clarification question. It does this by hardcoding direction words, not anything clever.

Example: ** Tests

	*: "Tests"

	Include Directional Disambiguation by Xavid.
	
	Library is a room.

	A thing called a red apple is here.
	A thing called a green apple is here.
	A thing called a pear is here.
	
	Study is south of Library.

	Test me with "put pear / south / north/ take apple / south / north / eat / south / north / lock pear / s".